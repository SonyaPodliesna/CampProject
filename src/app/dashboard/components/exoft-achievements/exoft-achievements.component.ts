...
export class ExoftAchievementsComponent {
  exoftAchievements = [
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg',
    dateEvent: new Date(2021, 2, 31, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records', xp: 15 },
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg',
    dateEvent: new Date(2021, 2, 29, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records', xp: 15 },
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg',
    dateEvent: new Date(2021, 3, 29, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records', xp: 15 },
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg',
    dateEvent: new Date(2021, 3, 29, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records', xp: 15 },
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg',
    dateEvent: new Date(2021, 3, 29, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records', xp: 15 },
