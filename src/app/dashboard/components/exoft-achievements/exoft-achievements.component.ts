...
export class ExoftAchievementsComponent implements OnInit {
  exoftAchievements = [
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg', dateEvent: new Date(2021, 2, 31, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records' },
    { userFirstName: 'Tanya', userLastName: 'Gogina', userAvatar: './assets/user-pic.jpg', dateEvent: new Date(2021, 2, 29, 12, 0, 0), eventText: 'Got achievement Exoft Turbo Power', eventType: 'Records' },
